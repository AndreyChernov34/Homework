...
public class Homework2 {
    ...
    public static void ex1() {
        ...
        for (var count = 0; count < words.length; count++) {
            finalText = finalText + words[count] + "-";
        }
        System.out.print(finalText.substring(0, finalText.length() - 1) + '\n');
        ...
        for (countVertical = 0; countVertical < arrayOfNumbers.length; countVertical++) {
            for (countHorizontal = 0; countHorizontal < arrayOfNumbers.length; countHorizontal++) {
                if (countVertical == countHorizontal) {
                    leftUpToRightDownSum = leftUpToRightDownSum + arrayOfNumbers[countVertical][countHorizontal];
                    break;
                }
            }
        }
